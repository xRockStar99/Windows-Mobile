...
wget https://github.com/xRockStar99/Windows-Mobile/raw/refs/heads/main/wine_C0h5NWUF0n.bmp && mkdir /storage/downloads/ImageConverter && mv wine_C0h5NWUF0n.bmp /storage/downloads/ImageConverter
